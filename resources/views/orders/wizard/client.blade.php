...
<head>
    ...
    <title>{{ isset($editData) ? 'Edição de Pedido' : 'Novo Pedido' }} - Dados do Cliente</title>
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <span class="text-base font-medium text-indigo-600">Dados do Cliente</span>
                        <p class="text-xs text-gray-500">Etapa 1 de 5</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="px-6 py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-lg font-semibold text-gray-900">{{ isset($editData) ? 'Edição de Pedido' : 'Novo Pedido' }}</h1>
                        <p class="text-sm text-gray-600">Informe os dados do cliente para continuar</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Formulário -->
            <form method="POST" action="{{ isset($editData) ? route('orders.edit-wizard.client') : route('orders.wizard.client') }}" id="client-form" class="space-y-6">
                @csrf
