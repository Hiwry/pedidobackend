...
<head>
    ...
    <title>Nova Opção de Produto</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-3xl mx-auto p-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold">Nova Opção de {{ $types[$type] }}</h1>
                <p class="text-sm text-gray-600 mt-1">Adicione uma nova opção de {{ strtolower($types[$type]) }}</p>
            </div>

            <form method="POST" action="{{ route('admin.product-options.store') }}" class="space-y-6">
                @csrf
